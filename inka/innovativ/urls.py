...
urlpatterns = [
    ...
    path('hatarido/<int:task_id>/', views.hatarido, name='hatarido'),
    ...
    path('p_04_1_ugyfelnek_felmeres/<int:task_id>/', views_projects04.p_04_1_ugyfelnek_felmeres,
         name='p_04_1_ugyfelnek_felmeres'),
    ...
    path('p_05_2_felmero_rogzites/<int:task_id>/', views_projects05.p_05_2_felmero_rogzites,
         name='p_05_2_felmero_rogzites'),
    path('p_05_2_ugyfel_atadasa_05_3_nak/<int:task_id>/', views_projects05.p_05_2_ugyfel_atadasa_05_3_nak,
    ...
    path('p_05_3_ugyfel_tovabbitasa_05_4_hez/<int:task_id>/', views_projects05.p_05_3_ugyfel_tovabbitasa_05_4_hez,
         name='p_05_3_ugyfel_tovabbitasa_05_4_hez'),
    path('p_05_4_felmeresi_kepek_kigyujtese/<int:task_id>/', views_projects05.p_05_4_felmeresi_kepek_kigyujtese,
         name='p_05_4_felmeresi_kepek_kigyujtese'),
